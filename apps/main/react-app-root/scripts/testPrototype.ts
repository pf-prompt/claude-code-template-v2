...
import { setupTestHooks } from '../frontend/prototype/setupTestHooks'
import { parseArgs } from 'node:util'
import { regressionTests } from '../common/infra/regressionTests'
import '../frontend/tests/prototypeTests'
...
function showHelp(): void {
  console.log(`
Regression Test Executor for Prototype

Usage: node testPrototype.js [options]
...
Examples:
  node testPrototype.js --module math
  node testPrototype.js --module hello --test "basic test"
  node testPrototype.js --test "specific test name"
`)
}
